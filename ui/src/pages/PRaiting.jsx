                        ...
                        <Row>
                            <Col sm={12} md={4}>
                                <Block color="white">
                                    ...
                                    <BlockLine>
                                        Рейтинг позволяет определить лучших среди лучших и составляен на основе влияния ответов экспертов на аудиторию.
                                    </BlockLine>
                                    <BlockLine>
                                        На рейтинг влияют такие показатели как количество ответов данных пользователем и монет заработанных за счет этих ответов
                                    </BlockLine>
                                </Block>
                            </Col>
                            <Col sm={12} md={8}>
